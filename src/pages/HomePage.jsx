  ...
  <section id="home-section-2">
    <div className="row">
      <div className="col-md-10">
        ...
        <p className="header-3 mt-0">oladigan mahsulotimizning
          asosiy afzalliklari quyidagilardan iborat</p>
      </div>
    </div>
    <div className="row mb-3">
      <div className="col-md-4">
        <div className="card">
          <div className="card-header border-0">
            <img className="px-3 py-3" src={Vector} alt />
          </div>
      ...
      <div className="col-md-4">
        <div className="card">
          <div className="card-header border-0">
            <img className="px-3 py-3" src={Vector1} alt />
          </div>
          <div className="card-body text-white position-relative">
            <div className="position-absolute bottom-0 pb-5 ps-5">
              <p className="card-title">Mustahkam material</p>
      ...
      <div className="col-md-4">
        <div className="card">
          <div className="card-header border-0">
            <img className="px-3 py-3" src={Vector2} alt />
          </div>
          <div className="card-body text-white position-relative">
            <div className="position-absolute bottom-0 pb-5 ps-5">
              <p className="card-title">Mustahkam material</p>
    ...
    <div className="row mb-5">
      <div className="col-md-4">
        <div className="card">
          <div className="card-header border-0">
            <img className="px-3 py-3" src={Vector3} alt />
          </div>
          <div className="card-body text-white position-relative">
            <div className="position-absolute bottom-0 pb-5 ps-5">
              <p className="card-title">Mustahkam material</p>
      ...
      <div className="col-md-4">
        <div className="card">
          <div className="card-header border-0">
            <img className="px-3 py-3" src={Vector4} alt />
          </div>
          <div className="card-body text-white position-relative">
            <div className="position-absolute bottom-0 pb-5 ps-5">
              <p className="card-title">Mustahkam material</p>
      ...
      <div className="col-md-4">
        <div className="card crd-2">
          <div className="card-body">
            <img className="img-fluid img" src={Rectangle7} alt />
            ...
            <div className="row">
              <div className="col-md-6 mb-3">
                <div className="sm px-2">
                  <img src={Vector5} alt />
                  2 sm <span className="small float-end">eni</span>
                </div>
              </div>
